...
{% endblock %}
{% block db_body %}
    <div class="dashboard_container" ng-controller="Dashboard_vipmember_recordsBuy_Controller">
        ...
        <ul class="nav nav-tabs" role="tablist" style="margin: 0 auto;">
            ...
            <li role="presentation" class="active"><a href="#" id="tab-btn-history" data-toggle="tab" role="tab">卡卷购买记录</a></li>
...
{% block db_script %}
    <script type="text/javascript">
        ...
        db_vip_member.controller("Dashboard_vipmember_recordsBuy_Controller",['LoadingLayout',function(LoadingLayout) {
            LoadingLayout.hide();
        }]);
    </script>
{% endblock %}