...
{% endblock %}
{% block db_body %}
    <div class="dashboard_container" ng-controller="Dashboard_vipmember_recordsPay_Controller">
        ...
        <ul class="nav nav-tabs" role="tablist" style="margin: 0 auto;">
            <li role="presentation" class="active"><a href="#" id="tab-btn-home" data-toggle="tab" role="tab">买单记录</a></li>
...
{% block db_script %}
    <script type="text/javascript">
        ...
        db_vip_member.controller("Dashboard_vipmember_recordsPay_Controller",['LoadingLayout',function(LoadingLayout) {
            LoadingLayout.hide();
        }]);
    </script>
{% endblock %}